...
import net.mcreator.guessnumber.init.GuessnumberModCommands;
...
public class GuessnumberMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(GuessnumberMod.class);
	public static final String MODID = "guessnumber";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing GuessnumberMod");
		GuessnumberModVariables.variablesLoad();
		GuessnumberModMenus.load();
		GuessnumberModCommands.load();
		tick();
