...
import net.mcreator.guessnumber.client.gui.GuessNumberScreen;
...
public class GuessnumberModScreens {
	public static void clientLoad() {
		MenuScreens.register(GuessnumberModMenus.GUESS_NUMBER, GuessNumberScreen::new);
	}
